    ...
    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
      ...
      <div class="sm:col-span-2">
        ...
        <div class="mt-2.5">
          ...
          <input type="checkbox" id="showPasswordCheckbox"> <!-- or use type="button" if you prefer a button -->
          <label for="showPasswordCheckbox"><b><small>Show Password</small></b></label>
          <script>
      ...
      <label for="Password" class="block text-sm font-semibold leading-6 text-gray-900"> Confirme Password :</label>
          ...
          <script>
        const passwordInput1 = document.getElementById('confirme password');
...
<select id="country" onchange="updatePhonePrefix()">
    <option value="US">United States (+1)</option>
    <option value="UK">United Kingdom (+44)</option>
    <option value="MA">Morocco (+212)</option>
    <option value="PA">Palistine (+970)</option>
...
<script>
    function updatePhonePrefix() {
        ...
        // Update phone number prefix based on country
        switch (country) {
            case 'US':
                phoneInput.value = "+1 ";
                break;
            ...
            case 'MA':
                ...
                break;
            case 'PA':
                phoneInput.value = "+970";
            // Add more cases for other countries as needed
            default:
                phoneInput.value = ""; // Clear value if country not recognized
                break;
        }
    }
</script>
      ...
      <div class="flex gap-x-4 sm:col-span-2">
        ...
        <label class="text-sm leading-6 text-gray-600" id="switch-1-label">
          ...
          <a href="#" class="font-semibold text-indigo-600">privacy&nbsp;policy</a><br><br>
        </label>
      </div>
